...
def test_get_all_entities_success():
    with patch('models.base.Base.get_all_by', return_value=[{"data": "entity1"}]):
        response, status_code = get_all_entities(MockEntity)
        assert status_code == 200
        assert response == {'all_mockentity': [{"data": "entity1"}]}
#
# def test_search_entities_no_entity_found():
#     with patch('models.base.Base.get_entities_by_search_values', return_value=None):
...
#     with patch('models.base.Base.get_entities_by_search_values', return_value=["entity1", "entity2"]):
#         response, status_code = search_entities(MockEntity, "search_val", "col1")
#         assert status_code == 200
...
#     with patch('models.base.Base.get_entity_with_joins', return_value="entity_data"):
#         response, status_code = get_entity_by_id(MockEntity, 1)
#         assert status_code == 200
